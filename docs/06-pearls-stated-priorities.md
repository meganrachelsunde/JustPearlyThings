...
3. Terrence Popp's nonprofit — likely **Second Class Citizen**, his existing 501(c)(3) for combat veterans and men inside the family-court system (per redonkulas.com and A Voice for Men): confirm this is the intended recipient, and how money should flow to it (grant, fiscal sponsorship, direct donation link).
